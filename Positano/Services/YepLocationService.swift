    ...
    var currentLocation: CLLocation? {
        didSet {
            if let currentLocation = currentLocation {
                PositanoUserDefaults.userCoordinateLatitude.value = currentLocation.coordinate.latitude
                PositanoUserDefaults.userCoordinateLongitude.value = currentLocation.coordinate.longitude
            }
        }
    }
    var address: String?
